...
export function resolveCacheDir(): string {
  ...
  if (process.env.WALLET_ANDROID_CACHE) {
    return process.env.WALLET_ANDROID_CACHE;
  }

  return join(homedir(), ".wallet-android-mcp", "repo");
}
...
export function resolveRepoUrl(): string | undefined {
  ...
  return process.env.WALLET_ANDROID_REPO_URL || undefined;
}
...
export function resolveBranch(): string {
  ...
  return process.env.WALLET_ANDROID_BRANCH || DEFAULT_BRANCH;
}
