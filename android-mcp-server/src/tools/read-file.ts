/**
 * Tool: read_file
 * Read a specific file from the Android repo by relative path.
 */
import { z } from "zod";
import { repoPath, readTextFile, fileExists } from "../repo.js";

export const readFileSchema = z.object({
  path: z.string().describe('Relative path from repo root, e.g. "earn/presentation/src/main/java/.../EarnViewModel.kt"'),
